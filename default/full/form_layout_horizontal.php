					...
					<div class="col-md-6">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Dar de alta a un alumno</h5>
							...
							<div class="card-body">
								<form action="#" method="post">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Ingrese sus apellido" id="Apellido">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Ingrese su correo electronico" id="correo">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="tel" class="form-control" placeholder="Ingrese su numero telefonico" id="telefono">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Ingrese su direccion" id="direccion">
										</div>
									</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Dar de alta a un Maestro</h5>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
							...
							<div class="card-body">
								<form action="#" method="post">
									...
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Apellido:</label>
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Ingrese sus apellidos " id="Apellido">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Ingrese su Profesion" id="Profesion">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="Ingrese su Contacto" id="Contacto">
										</div>
									</div>
									<div class="form-group row">
										<label class="col-lg-3 col-form-label">Carrera:</label>
										<div class="col-lg-9">
											<input type="text" class="form-control" placeholder="De que carrera es" id="Carrera">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<textarea rows="5" cols="5" class="form-control" placeholder="Materias que puede impartir" id="impartir"></textarea>
										</div>
									</div>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Dar de alta una materia</h5>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Dar de alta una carrera</h5>
								<div class="header-elements">
									<div class="list-icons">
				                		<a class="list-icons-item" data-action="collapse"></a>
				                		<a class="list-icons-item" data-action="reload"></a>
