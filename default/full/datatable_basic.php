				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Themes">
								<li class="nav-item"><a href="../../../LTR/default/full/form_layout_horizontal.html" class="nav-link active">Alta</a></li>
								<li class="nav-item"><a href="../../../LTR/default/full/datatable_basic.php" class="nav-link active">Consultar </a></li>
							</ul>
						</li>	
						<li class="nav-item nav-item-submenu">
					...
					<table class="table datatable-basic" width="100%">
						...
						<tbody>
							...
							<tr>
								<td>1930263</td>
								<td>Jose Carlos</td>
								<td> Hernandez Cortez</td>
								<td>jose2001</td>
								<td>Hombre</td>
								<td>1930263@upv.edu.mx</td>
								<td>8342471567</td>
								<td>Mexicano</td>
								<td>Los arcos</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<li>
												<ul><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_default">editar </button></ul>
								...
								<td>1930242</td>
								<td>Maria </td>
								<td>Gutierrez rios</td>
								<td>mariaG01</td>
								<td>Mujer</td>
								<td>1930242@upv.edu.mx</td>
								<td>8342472486</td>
								<td>Mexicana</td>
								<td>Los arcos</td>
								<td class="text-center">
					...
					<table class="table datatable-pagination" width="100%">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>Mario Carlos </td>
								<td>Gutierrez Mesa</td>
								<td>MC01</td>
								<td>Hombre</td>
								<td>MCGM@upv.edu.mx</td>
								<td>8342593254</td>
								<td>8345867894</td>
								<td>Ing.TI</td>
								<td>ITI</td>
								<td>Algebra,Ingles,ITI</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
								...
								<td>2</td>
								<td>Maria Carla </td>
								<td>Hernandez Mesa</td>
								<td>MCHM2</td>
								<td>Hombre</td>
								<td>MCHM@upv.edu.mx</td>
								<td>8342594862</td>
								<td>8345878541</td>
								<td>Ing.TI</td>
								<td>ITI</td>
								<td>Introducion a la programacion</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
					...
					<table class="table datatable-basic" width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td>ITI</td>
								<td>Es una materia de la carrera de iti</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											<a href="#" class="list-icons-item" data-toggle="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<li>
												<ul><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_materia">editar </button></ul>
												<ul><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_delete">borrar </button></ul>
												</li>
											</div>
										</div>
					...
					<table class="table datatable-basic" width="100%">
						...
						<tbody>
							...
							<tr>
								<td>1</td>
								<td>ITI</td>
								<td>Ingenieria en tecnologias de la informacion es una carrera, que se proporciona en la upv</td>
								<td>1</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<li>
												<ul><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_carreras">editar </button></ul>
												<ul><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_delete">borrar </button></ul>
												</li>
											</div>
										</div>
							...
							<tr>
								<td>3</td>
								<td>PIMES</td>
								<td>Es una carrera, que se proporciona en la upv</td>
								<td>1</td>
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
